...
import { useFeedCreate } from '../../../apis/social/useFeedFetch'
...
export const SocialFeedCreateModal = ({ isOpen, onClose }: SocialFeedCreateModalProps) => {
		...
		<div className='fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm' onClick={handleClose}>
			<div className='bg-white rounded-2xl shadow-2xl w-full max-w-lg mx-4 max-h-[90vh] overflow-y-auto' onClick={(e) => e.stopPropagation()}>
				...
				<div className='flex items-center justify-between p-6 border-b border-gray-200'>
					<h2 className='text-2xl font-bold text-gray-800'>피드 작성</h2>
					<button
						onClick={handleClose}
				...
				<div className='flex gap-3 p-6 border-t border-gray-200'>
					<button
						onClick={handleClose}
						className='flex-1 px-6 py-3 bg-gray-100 text-gray-700 rounded-full font-semibold hover:bg-gray-200 transition-all duration-200'>
						취소
					</button>
					<button
