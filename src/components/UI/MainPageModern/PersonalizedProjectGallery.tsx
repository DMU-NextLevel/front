...
const PersonalizedProjectGallery: React.FC = () => {
  ...
  return (
    <section className='mt-10 py-5 px-[15%]' data-aos='fade-up'>
      <div className='flex items-end justify-center mb-4'>
        <div>
          <h2 className='text-xl md:text-2xl font-bold text-center'>인기 프로젝트</h2>
          <p className='mt-1 text-xs text-gray-500 text-center'>지금 가장 인기 있는 프로젝트들을 만나보세요</p>
        </div>
      </div>
      ...
      {!loading && (
        <div className='relative overflow-visible'>
          <div 
            ref={sliderRef} 
            className='flex overflow-x-auto snap-x snap-proximity gap-1 pt-1 pr-20 md:pr-24 pb-16 md:pb-20 webkit-scrollbar-hidden -ml-4'
            style={{
            ...
            {projects.slice(0, 5).map((p) => {
              ...
              return (
                ...
                >
                  ...
                  <div className='absolute inset-0 bg-white border border-transparent group-hover:border-gray-200 rounded-sm group-hover:rounded-b-none group-hover:shadow-lg transition-all duration-300 ease-out z-10'></div>
